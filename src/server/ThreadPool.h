...
void ThreadPool<parameterT>::Launch(parameterT param) {
	 ...
	 */
	//std::cout<<"before pushback:"<<params.size()<<std::endl;
	params.push_back(param);
	//std::cout<<"after pushback:"<<params.size()<<std::endl;
	OSSpecific::UnlockMutex(poolAccess);
}
...
(ThreadWrapper<parameterT>* pWrapper) {
	...
	//std::cout<<"before popback:"<<params.size()<<std::endl;
		params.pop_front();
	//std::cout<<"after popback:"<<params.size()<<std::endl;
		OSSpecific::UnlockMutex(poolAccess);
